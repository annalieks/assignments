...
class DisplayInfo:
    def __init__(self, height, width):
        ...
        self.ghost_img_left = [pygame.image.load("sprites/ghost1_left.png"),
                               pygame.image.load("sprites/ghost2_left.png")]
        self.ghost_img_right = [pygame.image.load("sprites/ghost1_right.png"),
                                pygame.image.load("sprites/ghost2_right.png")]
        self.ghost_img_up = [pygame.image.load("sprites/ghost1_up.png"),
                             pygame.image.load("sprites/ghost2_up.png")]
        self.ghost_img_down = [pygame.image.load("sprites/ghost1_down.png"),
                               pygame.image.load("sprites/ghost2_down.png")]
