...
public class Sysprogrammingmainalgorithm {
    ...
    private static int[] createEpsilonNonterminals(MyLang lang) {
        ...
        do {
            ...
            switch (codeAction) {
                ...
                case 8: //Друк списку епсілон-нетерміналів
                    int[] epsilonCustom = createEpsilonNonterminals(testLang);
                    testLang.printEpsilonNonterminals();

                    System.out.println("Actual");
                    testLang.setEpsilonNonterminals(epsilonCustom);
                    testLang.printEpsilonNonterminals();
                    break;
