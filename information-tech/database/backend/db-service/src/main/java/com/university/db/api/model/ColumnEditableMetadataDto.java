...
public class ColumnEditableMetadataDto   {
  ...
  public ColumnEditableMetadataDto name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ColumnEditableMetadataDto columnEditableMetadataDto = (ColumnEditableMetadataDto) o;
    return Objects.equals(this.name, columnEditableMetadataDto.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class ColumnEditableMetadataDto {\n");
