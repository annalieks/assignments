...
public class DatabaseMetadataDto   {
  ...
  public DatabaseMetadataDto name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DatabaseMetadataDto databaseMetadataDto = (DatabaseMetadataDto) o;
    return Objects.equals(this.name, databaseMetadataDto.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatabaseMetadataDto {\n");
